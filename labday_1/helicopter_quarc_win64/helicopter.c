 ...
 * C source code generated on : Wed Feb  3 08:48:47 2021
 *
...
void helicopter_output(void)
{
  ...
  if (helicopter_M->Timing.t[0] < helicopter_P.Step_Time) {
    rtb_Sum1_n = helicopter_P.Step_Y0;
  } else {
    rtb_Sum1_n = helicopter_P.Step_YFinal;
  }
   ...
   *  Sum: '<S5>/Sum3'
   */
  rtb_Sum1_n = ((rtb_Sum1_n - helicopter_P.Gain1_Gain * helicopter_B.Gain_i) *
                helicopter_P.K_pp - helicopter_P.Gain1_Gain *
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Derivative = (rtb_Backgain - rtb_Sum1_n) * helicopter_P.Backgain_Gain;
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Derivative = (rtb_Sum1_n + rtb_Backgain) * helicopter_P.Frontgain_Gain;
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (1431712909U);
  helicopter_M->Sizes.checksums[1] = (1529803249U);
  helicopter_M->Sizes.checksums[2] = (664571179U);
  helicopter_M->Sizes.checksums[3] = (2346193807U);
  ...
  helicopter_M->Sizes.numBlocks = (54);/* Number of blocks */
